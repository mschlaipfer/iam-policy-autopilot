#!/usr/bin/env node
/**
 * CDK App entry point for run_005: Secure Repository Monitoring
 *
 * Usage:
...
import { SecureRepoMonitoringStack } from '../lib/stack';

const app = new cdk.App();

new SecureRepoMonitoringStack(app, 'SecureRepoMonitoringStack-run003-3cbeaff7', {
