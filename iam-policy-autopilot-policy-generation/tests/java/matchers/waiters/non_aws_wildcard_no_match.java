// NOTE: This file does not compile — `dynamoDbClient` and `request` are undeclared.
...
//
// A non-AWS wildcard import whose package happens to contain a type named "DynamoDbWaiter"
// with a method named "waitUntilTableExists" — both coincidentally matching AWS SDK names.
