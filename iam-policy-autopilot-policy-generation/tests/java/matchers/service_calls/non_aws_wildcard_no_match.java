...
//
// A non-AWS wildcard import whose package happens to contain a type named "S3Client"
// with a method named "getObject" — both coincidentally matching AWS SDK names.
...
class NonAwsWildcardNoMatch {
    void run() {
        S3Client client = MyFactory.create();
